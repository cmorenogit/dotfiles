...
|---------------|-------------|-------------|
| `prd-review` | prd-review | PRD completeness gap report (28-check product score) |
| `module-design-review` | module-design-review | Module Design architecture validation (34-check technical score) |
| `module-design` | module-design | Module Design Document (screens, architecture, ADRs) |
